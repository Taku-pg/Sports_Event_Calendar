...
- root page (http://localhost:8080)
   - View list of events
   - View detail of each event by clicking detail button
   - Transit to create new event page from navigation bar
     
- create new event page (http://localhost:8080/add-event)
